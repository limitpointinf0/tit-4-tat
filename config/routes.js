...
module.exports.routes = {
  ...
  'GET /advertise/':                  {action: 'advertise/advertise-dashboard'},
  'GET /advertise/instagram/:virtualPageSlug?': {action: 'advertise/instagram/list-instagram'},

  'GET /publish/':                                      {action: 'publish/publish-dashboard'},
  'GET /publish/instagram/':           {action: 'publish/instagram/list-instagram'},
  ...
  'POST   /api/v1/advertise/instagram/':              { action: 'advertise/instagram/upload-instagram'},
  'DELETE  /api/v1/advertise/instagram/:id':          { action: 'advertise/instagram/destroy-one-instagram' },
  'POST   /api/v1/publish/instagram/':                { action: 'publish/instagram/user-instagram-engagement'},
  'POST   /api/v1/publish/check-instagram/':          { action: 'publish/instagram/check-instagram-engagement'},
